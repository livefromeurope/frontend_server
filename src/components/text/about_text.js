    ...
    <div className="About">
        ...
        <h1>About</h1>
            ...
            5.<strong> livefromeurope:</strong> is a REACT APP build with the MERN stack as well as a Python Backend crawler.
              ...
              <a >
                  <img width="100px"  src='https://upload.wikimedia.org/wikipedia/commons/thumb/c/c3/Python-logo-notext.svg/1200px-Python-logo-notext.svg.png' />
              </a>
            <p>
            6.<strong> livefromeurope:</strong> os open source, published on github: https://github.com/livefromeurope 
            <p >
              <a href="https://github.com/livefromeurope">
                  <img width="600px"  src='https://miro.medium.com/max/1400/0*c43pw7UiQgpfjDCl.jpg' />
              </a>
            </p>
            </p>
            <p>
